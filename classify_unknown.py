...
AUTO_RULES: list[tuple[str, str]] = [
    # food (groceries / bakeries / butchers)
    ("BRENNERS", "food"),
    ...
    # fun (restaurants / cafés / fast food)
    ("MCDONALDS", "fun"),
    ("MCDONALD S", "fun"),
    ("MC DONALDS", "fun"),
    ("BURGER KING", "fun"),
    ...
    ("Rothaler Pitac", "fun"),
    ("Danilas Grill", "fun"),
    ("JOESEPPS BRAUHAUS", "fun"),
    ("Barrel House", "fun"),
    ("OLD WILD WEST", "fun"),
    ("LA CREMERIA", "fun"),
    ("GELATERIA", "fun"),
    ("Aichinger Gastro", "fun"),
    ("Sunshine Diner", "fun"),
    ("CAFE ADELBERT", "fun"),
    ("WENDYS", "fun"),
    ("TIM HORTONS", "fun"),
    ...
    ("IKEA", "renovation"),
    ("JYSK", "renovation"),
    ("MOEBEL INHOFER", "renovation"),
    ("Thomas Philipps", "renovation"),
    ("STAHLTRAEG", "renovation"),
    # shopping
    ("KiK Fil", "shopping"),
    ("KiK ", "shopping"),
    ("H&M", "shopping"),
    ...
    ("SumUp *Donaugold", "fun"),
    # mobility
    ("Admiral Direkt", "mobility"),
    ("AdmiralDirekt", "mobility"),
    ...
    ("SANTANDER", "car_loan"),
    ("OPENBANK", "car_loan"),
    ("Darl.-Leistung", "house_loan"),
    ("Darl.-Le", "house_loan"),
    ("6138228728", "house_loan"),
    ("61382287", "house_loan"),
    ("DE59NUI00000001623", "house_loan"),
    ...
    ("NEBENKOSTEN", "housing"),
    ("NEBENK", "housing"),
    ("401849xxxxxx4142", "transfers"),
    ("Abrechnung vom", "transfers"),
    ("Karte Nr. 401849", "transfers"),
    ("Lastschrifteinzug", "transfers"),
    ("Gehalt Kompenstion", "compensation"),
    ("Kompenstion", "compensation"),
    ("Thilo Bleumer Ausgleich", "compensation"),
    ("Bleumer-Ventures", "compensation"),
    # income
    ("Bundeskasse", "income"),
...
def main() -> None:
    ...
    if dry_run:
        ...
        for tx in before_txs:
            if tx["category"] != "unclassified":
                continue
            result = budget.classify_text(tx["text"])
            if not result:
                sim_n += 1
